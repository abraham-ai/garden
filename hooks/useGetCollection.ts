...
const useGetCollection = (
  collectionId: string
): SWRResponse<CollectionResponse, any> & { mutate: (data?: CollectionResponse | Promise<CollectionResponse> | ((data: CollectionResponse) => CollectionResponse), shouldRevalidate?: boolean) => Promise<CollectionResponse | undefined> } => {
